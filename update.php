...
<body>
    <div class="container">
        ...
        <form id="signupForm" action="update_process.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
            <input type="text" id="name" name="name" placeholder="Name" value="<?php echo $fetch_data['name']; ?>" required>            
            <input type="email" id="email" name="email" placeholder="Email" value="<?php echo $fetch_data['email']; ?>" required>
            <input type="text" id="phone" name="phone" placeholder="Phone Number" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="10" value="<?php echo $fetch_data['phone_no']; ?>"   required">
            <?php if (!empty($fetch_data['photo'])): ?>
            <?php $photo_path = $fetch_data['photo']; ?>
            <img src="<?php echo $photo_path; ?>" style="max-width: 200px; max-height: 200px;"><br><br>
        <?php endif; ?>
        <label for="photo">Upload Your Photo:</label><br>
    <input type="file" id="photo" name="photo" accept="image/*" required><br><br>
            <input type="date" id="dob" name="dob" placeholder="Date of Birth" value="<?php echo $fetch_data['dob']; ?>" required>                        
            ...
            <button type="update_profile" value="update_profile"class="btn" name="update_profile">Update </button>
        </form>
